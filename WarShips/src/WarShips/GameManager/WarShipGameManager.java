...
import WarShips.*;
import WarShips.AI.AIHeavyDecisionMaker;
import WarShips.AI.AIHumanDecisionMaker;
import WarShips.AI.AIRandomDecisionMaker;
...
/**
 *  WarShipGameManager implements common war ships' game logic,
 *  provides menu by using inputManager and runs
 *  main loop of game
 */
public class WarShipGameManager implements BasicGameManager {

    public WarShipGameManager() {
        playersCount = 3;
        isDone = false;
